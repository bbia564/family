import 'package:family_finance/pages/home/create/check_item.dart';
import 'package:family_finance/pages/home/create/family_logic.dart';
...
class FamilyExpensesTab extends StatelessWidget {
  const FamilyExpensesTab({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<FamilyExpensesLogic>(
        init: FamilyExpensesLogic(),
        builder: (logic) {
